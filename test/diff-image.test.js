...
describe('diff-image', function() {
  ...
  describe('captureDiffImage', function() {
    it('returns null when native renderer throws', async function() {
      ...
      // Mock the compare API with correct endpoint: /w/rest.php/v1/revision/{fromrev}/compare/{torev}
      // diff=123 (torev), oldid=456 (fromrev)
      nock('https://en.wikipedia.org')
        .get('/w/rest.php/v1/revision/456/compare/123')
        .reply(200, {
          diff: [
      ...
      // Mock BLP status fetch (fail-soft)
      nock('https://en.wikipedia.org')
        .get(/\/w\/api\.php/)
        .reply(404)
      ...
      assert.isTrue(renderWasCalled, 'Renderer should have been called')
    })
  })
})
