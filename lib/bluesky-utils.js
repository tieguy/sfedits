...
function buildFacets(text, page, name, pageUrl, userUrl) {
  ...
  // Emit in text order. @atproto/api sorts on construction anyway, but a
  // name-first template would otherwise yield descending byteStarts and a
  // third-party renderer may assume ascending order.
