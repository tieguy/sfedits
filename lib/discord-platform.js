...
function buildDiscordEmbed(metadata, filename) {
  ...
  descriptionParts.push(
    `**${clip(summary.sentence.charAt(0).toUpperCase() + summary.sentence.slice(1), 300)}** · [view diff](${metadata.diffUrl})`
  )
...
module.exports = { post, buildDiscordText, buildDiscordEmbed }
