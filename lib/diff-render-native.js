 ...
 * data/fonts/ - if that fetch fails, rendering proceeds without CJK glyphs.
 */
...
// Styling palette (layout and colors for diff rendering)
const C = {
  text: '#202122',
  muted: '#54595d',
  faint: '#72777d',
 ...
 * (lib/diff-image.js) return null on failure.
...
/**
 * Render the model and write it to a temp PNG file.
 * @param {Object} model - From buildDiffModel()
