 ...
 * @param {string|null} params.discordMessageId - Discord webhook message id
 */
function recordPost({ diffUrl, page, blueskyUri = null, mastodonId = null, discordMessageId = null }, logFile = DEFAULT_LOG_FILE) {
